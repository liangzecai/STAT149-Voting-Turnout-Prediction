...
```{r}
## parameters to tune
ntree_val = c(100, 200, 300)
mtry_val = c(2, 4, 6, 8, 10, 12, 14, 16)
```
...
legend(12, 0.58, c("n_tree = 100", "n_tree = 200", "n_tree = 300"),
...
#score = cv_score_rf(ntree = 600, mtry = 2, data = sample_n(train, 10000))
